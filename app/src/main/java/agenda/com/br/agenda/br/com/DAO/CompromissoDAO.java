...
public class CompromissoDAO extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE Compromisso (id INTEGER PRIMARY KEY AUTOINCREMENT, descricao TEXT NOT NULL, data DATE NOT NULL, contato TEXT)";
        db.execSQL(sql);
    }
    ...
    public List<Compromisso> buscaCompromisso() {
        ...
        while(cursor.moveToNext()){
            ...
            compromisso.setId(cursor.getInt(cursor.getColumnIndex("id")));
